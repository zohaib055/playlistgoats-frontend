...
export default class TrailAccount extends Component {
    constructor(props) {
        super(props);
        this.handleTrainRequest = this
            .handleTrainRequest
            .bind(this);
    ...
    handleTrainRequest(e) {
        ...
        if (this.checkBtn.context._errors.length === 0) {
            AuthService
                .requestTrailAccount(this.state.email)
                .then(response => {
                    this
                    .props
                    .history
                                    ...
                                    <div class="row g-0 h-100">
                                        ...
                                        <div class="col-md-7 d-flex flex-center">
                                            <div class="p-4 p-md-5 flex-grow-1">
                                                ...
                                                <Form
                                                    onSubmit={this.handleTrainRequest}
                                                    ref={c => {
                                                        this.form = c;
                                                    }}>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Get Account</button>
                                                    </div>
                                                    <CheckButton
                                                        style={{
                                                            display: "none"
